...
public class PlayerSoundFX : MonoBehaviour 
{
    ...
    [SerializeField]
    private PlayType attackPlayMode = PlayType.Random;
    private int curAttackInd;
    [SerializeField]
    private AudioClip[] jumps;
    [SerializeField]
    private PlayType jumpPlayMode = PlayType.Random;
    private int curJumpInd;
    [SerializeField]
    private AudioClip[] hurts;
    [SerializeField]
    private PlayType hurtPlayMode = PlayType.Random;
    private int curHurtInd;
    [SerializeField]
    private AudioClip[] deaths;
    [SerializeField]
    private PlayType deathPlayMode = PlayType.Random;
