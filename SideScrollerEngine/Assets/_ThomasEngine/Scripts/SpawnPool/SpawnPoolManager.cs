...
public class SpawnPoolManager: ScriptableObject
{
    ...
    public GameObject SpawnObject(int _poolIndex, Vector2 _pos, Quaternion _rot, Transform _parent = null)
    {
        if (pools.Count < 1)
            return null;
    ...
    public GameObject SpawnObject(GameObject _objToSpawn, Vector2 _pos, Quaternion _rot, Transform _parent = null)
    {
        return SpawnObject(_objToSpawn.name, _pos, _rot, _parent);
    }

    public GameObject SpawnObject(string _objToSpawn, Vector2 _pos, Quaternion _rot, Transform _parent = null)
    {
