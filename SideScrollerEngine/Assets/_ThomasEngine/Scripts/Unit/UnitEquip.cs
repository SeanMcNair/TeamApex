...
public class UnitEquip : MonoBehaviour
{
    ...
    public bool CurItemInUse { get { if (curItem)return curItem.IsInUse; else return false; } }
    ...
    {
        spawnLoc = unit.ItemSpawnLocation;
    }
    ...
    public virtual void DropCurrentItem()
    {
        ...
        var item = dropped.GetComponent<ItemUseable>();
