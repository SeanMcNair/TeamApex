...
{
    [SerializeField] private bool overrideSender;
    [SerializeField] private TagProperty senderTag;
    [SerializeField] private TagProperty targetTag;
    [SerializeField] private float speed = 5;
    [SerializeField] private bool doFXOnFinish;
    ...
    IEnumerator MoveTowards(Transform _trans, Transform _targetPos)
    {
        ...
        if (doFXOnFinish)
        {
            ...
            {
                fx.DoFX(_trans.gameObject, _targetPos.gameObject);
            }
        }
    }
